...
|---|---|
| Keys in `DEFAULTS` | 87 |
| Exposed as sliders | 46 |
| Reachable only through `__gsNext.tuning()` | 41 |
<!-- /generated:coverage -->
...
| File | Lines |
|---|---|
| `src/client/audio.ts` | 789 |
| `src/client/main.ts` | 559 |
| `src/sim/track.ts` | 441 |
| `src/sim/step.ts` | 426 |
| `src/client/ship.ts` | 418 |
| `src/client/sliders.ts` | 400 |
| `src/client/track-mesh.ts` | 313 |
| `src/sim/tuning.ts` | 305 |
<!-- /generated:oversize -->
