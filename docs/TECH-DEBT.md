...
| | |
|---|---|
| Keys in `DEFAULTS` | 106 |
| Exposed as sliders | 49 |
| Reachable only through `__gsNext.tuning()` | 57 |
<!-- /generated:coverage -->
...
| File | Lines |
|---|---|
| `src/client/main.ts` | 1563 |
| `src/client/audio.ts` | 1241 |
| `src/client/ship.ts` | 757 |
| `src/sim/step.ts` | 582 |
| `server/src/auth.ts` | 562 |
| `src/sim/tuning.ts` | 492 |
| `server/src/room.ts` | 466 |
| `server/src/index.ts` | 459 |
| `src/client/sliders.ts` | 424 |
| `src/sim/generator.ts` | 420 |
| `src/client/screens.ts` | 399 |
| `src/client/settings.ts` | 397 |
| `src/client/track-mesh.ts` | 380 |
| `server/src/arbiter.ts` | 357 |
| `src/client/feedback.ts` | 352 |
| `src/client/camera.ts` | 338 |
| `src/client/flyby.ts` | 328 |
| `src/client/qr.ts` | 323 |
| `src/client/hud.ts` | 315 |
<!-- /generated:oversize -->
