...
| File | Lines |
|---|---|
| `src/client/main.ts` | 1170 |
| `src/client/audio.ts` | 1052 |
| `src/client/ship.ts` | 597 |
| `server/src/auth.ts` | 509 |
| `src/sim/step.ts` | 471 |
| `src/client/sliders.ts` | 424 |
| `src/sim/generator.ts` | 421 |
| `server/src/room.ts` | 408 |
| `src/sim/tuning.ts` | 390 |
| `server/src/index.ts` | 357 |
| `src/client/screens.ts` | 348 |
| `src/client/track-mesh.ts` | 344 |
| `server/src/arbiter.ts` | 343 |
| `src/client/settings.ts` | 330 |
| `src/client/qr.ts` | 317 |
