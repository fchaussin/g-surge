...
| File | Lines |
|---|---|
| `src/client/main.ts` | 1089 |
| `src/client/audio.ts` | 1052 |
| `src/client/ship.ts` | 597 |
| `src/sim/step.ts` | 471 |
| `server/src/auth.ts` | 437 |
| `src/client/sliders.ts` | 424 |
| `src/sim/generator.ts` | 421 |
| `server/src/room.ts` | 392 |
| `src/sim/tuning.ts` | 390 |
| `server/src/arbiter.ts` | 348 |
| `server/src/index.ts` | 347 |
| `src/client/track-mesh.ts` | 344 |
| `src/client/screens.ts` | 334 |
| `src/client/hud.ts` | 315 |
| `src/client/settings.ts` | 312 |
<!-- /generated:oversize -->
