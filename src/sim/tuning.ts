...
export const DEFAULTS: Readonly<Tuning> = {
  ...
  renderScale: 1,
  launchScale: 0.50, airGravity: 3.4, airThresh: 2.2, airSteer: 0.40, airOverhang: 11,
  badLanding: 0.35,
...
export const DIFF: Readonly<Record<Difficulty, DifficultyDef>> = {
  ...
  medium: {
    mul: 1.35,
    set: {
      curveLoad: 38, speedRamp: 6000, hullImpact: 2.6, hullRegen: 1.2, hullScrape: 19,
  ...
  hard: {
    mul: 1.8,
    set: {
      curveLoad: 46, speedRamp: 4000, hullImpact: 3.4, hullRegen: 0.8, hullScrape: 24,
